...
const ButtonReturnDorrow = ({ equipmentId, equipmentName }) => {
  ...
  return (
    <div className="showborrow-container">
      <button className="open-modal-btn" onClick={openModal} style={{backgroundColor : "#ffaf38"}}>
        ยืมอุปกรณ์ซ้ำ
      </button>
      <Modal
        isOpen={isModalOpen}
...
export default ButtonReturnDorrow